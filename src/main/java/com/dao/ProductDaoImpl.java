   ...
   public void edit(ProductModel productmodel){
	...
	public void delete(int getId){
		...
		public List getALLonear() {
			...
			return session.getCurrentSession().createQuery("from ProductModel where category='onear'").list();
		...
		public List getALLoverear() {
			// TODO Auto-generated method stub
			return  session.getCurrentSession().createQuery("from ProductModel where category='overear'").list();
		}

		@Override
		public List getALLbluetooth() {
			// TODO Auto-generated method stub
			return  session.getCurrentSession().createQuery("from ProductModel where category='bluetooth'").list();
		}

		@Override
		public List getALLearbud() {
			// TODO Auto-generated method stub
			return  session.getCurrentSession().createQuery("from ProductModel where category='earbud'").list();
		}
