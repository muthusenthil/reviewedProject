...
public class FrontController {
	...
	@RequestMapping(value={"/","admin/back","/index","/back","user/back"})
...
/*@RequestMapping(value="/user/shownxt")
	
	private String multijoy()
	{
		return "showpage";
	}*/
	...
	@RequestMapping({"/cartview","addtocart/cartview"})//mine
	private String multipart()
	{
		return "cartview";//view cart
	}
